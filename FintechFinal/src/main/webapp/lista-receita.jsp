		...
		<table class="table table-striped">
			...
			<c:forEach items="${receitas}" var="r">
				<tr>
					...
					<td>${r.valor}</td>
					<td>
						<fmt:formatDate value="${r.dataReceita.time }" pattern="dd/MM/yyyy"/>
					</td>
					<td>
				        ...
				        <button type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#excluirModal" onclick="codigoExcluir.value = ${r.codigo}">
				            Excluir
				        </button>						
					</td>
				</tr>
